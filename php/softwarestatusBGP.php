<?php
/*
Template Name: Software Status - BGP
*/
?>
<?php get_header();?>
<div id="content">
                ...
                ul.sw li {
                    ...
                    <?php 
                        ...
                        if (($_GET["software"] == "")  && ($_GET["view"] == "") ){
                            the_content(); 
                            include('/sw/tools/www/bgp/alphabetical.html');
                        }elseif ( ($_GET["software"] == "") && ($_GET["view"] == "category") ){
                            the_content();
                            include('/sw/tools/www/bgp/category.html');
                        }elseif ($_GET["software"] != "" ){
                            include('/sw/tools/www/bgp/' . $_GET["software"]  .'.html');
                        }
                    ?> 
