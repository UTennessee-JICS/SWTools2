<?php
/*
Template Name: Software Status - Smoky
*/
?>
<?php get_header();?>
<div id="content">
                ...
                ul.sw li {
                    ...
                    <?php 
                        ...
                        if (($_GET["software"] == "")  && ($_GET["view"] == "") ){
                            the_content(); 
                            include('/sw/tools/www/smoky/alphabetical.html');
                        }elseif ( ($_GET["software"] == "") && ($_GET["view"] == "category") ){
                            the_content();
                            include('/sw/tools/www/smoky/category.html');
                        }elseif ($_GET["software"] != "" ){
                            include('/sw/tools/www/smoky/' . $_GET["software"]  .'.html');
                        }
                    ?> 
