<?php
/*
Template Name: Software Status - XT5
*/
?>
<?php get_header();?>
<div id="content">
                ...
                ul.sw li {
                    ...
                    <?php 
                        ...
                        if (($_GET["software"] == "")  && ($_GET["view"] == "") ){
                            the_content(); 
                            include('/sw/tools/www/xt5/alphabetical.html');
                        }elseif ( ($_GET["software"] == "") && ($_GET["view"] == "category") ){
                            the_content();
                            include('/sw/tools/www/xt5/category.html');
                        }elseif ($_GET["software"] != "" ){
                            include('/sw/tools/www/xt5/' . $_GET["software"]  .'.html');
                        }
                    ?> 
