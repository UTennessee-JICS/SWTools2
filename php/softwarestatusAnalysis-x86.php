<?php
/*
Template Name: Software Status - Analysis x86
*/
?>
<?php get_header();?>
<div id="content">
                ...
                ul.sw li {
                    ...
                    <?php 
                        ...
                        if (($_GET["software"] == "")  && ($_GET["view"] == "") ){
                            the_content(); 
                            include('/sw/tools/www/analysis-x86/alphabetical.html');
                        }elseif ( ($_GET["software"] == "") && ($_GET["view"] == "category") ){
                            the_content();
                            include('/sw/tools/www/analysis-x86/category.html');
                        }elseif ($_GET["software"] != "" ){
                            include('/sw/tools/www/analysis-x86/' . $_GET["software"]  .'.html');
                        }
                    ?> 
