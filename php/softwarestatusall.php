<?php
/*
Template Name: Software Status - All
*/
?>
<?php get_header();?>
<div id="content">
                ...
                ul.sw li {
                    ...
                    <?php 
                        ...
                        if (($_GET["software"] == "")  && ($_GET["view"] == "") ){
                            the_content(); 
                            include('/sw/tools/www/alphabetical.html');
                        }elseif ( ($_GET["software"] == "") && ($_GET["view"] == "category") ){
                            the_content();
                            include('/sw/tools/www/category.html');
                        }elseif ($_GET["software"] != "" ){
                            include('/sw/tools/www/' .$_GET["arch"]. '/' . $_GET["software"]  .'.html');
                        }
                    ?> 
