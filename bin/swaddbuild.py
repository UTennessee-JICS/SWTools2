...
'''
Driver for calling addbuild on apps in /sw tree.
...
# Parse options using a modified optparse. The modifications are implemented in parse.py
...
parser.add_option("-v","--version",default="current",help="version number")
parser.add_option("-b","--build",default=None,help="build name")
parser.add_option("--debug",action="store_true",default=False,help="debugging")
...
addbuild_addpackage.main(opts.architecture,opts.app,opts.version,opts.build,"addbuild",opts.debug)
