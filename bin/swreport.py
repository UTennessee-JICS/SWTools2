'''
Driver for calling report on apps in /sw tree.

See report.py for details on implementation.
'''
'''
...
parser.add_option("-a","--app",default="*",help="application name")
parser.add_option("-d","--diff",default=None,help="diff against previous report")
parser.add_option("--debug",action="store_true",help="debugging")
parser.add_option("-m","--architecture",default="*",help="architecture name")
parser.add_option("-b","--build",default="*",help="build name")
parser.add_option("-v","--version",default="*",help="version name")
parser.add_option("-r","--recurse",action="store_true",default=False,help="recurse into build directories to check permissions when running conform")
parser.add_option("-l","--long",action="store_false",default=True)
parser.add_option("-i","--hidestatus",help="hide verified/unverified status online",action="store_true",default=False)
parser.add_option("-e","--hidesupported",help="hide the support status in generated html pages",action="store_true",default=False)
