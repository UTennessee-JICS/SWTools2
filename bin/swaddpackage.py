'''
Driver for calling addpackage on apps in /sw tree.

See addbuild_addpackage.py for details on implementation.
'''
'''
...
addbuild_addpackage.main(opts.architecture,opts.app,opts.version,opts.build,"addpackage",opts.debug)
